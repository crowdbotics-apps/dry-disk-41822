"""
Django settings for dry_disk_41822 project.
...
ROOT_URLCONF = 'dry_disk_41822.urls'
...
WSGI_APPLICATION = 'dry_disk_41822.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_disk_41822 API",
    "DESCRIPTION": "API documentation for dry_disk_41822 App",
    "VERSION": "v1",
}
